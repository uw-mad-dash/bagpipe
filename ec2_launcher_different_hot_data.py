...
run_args_oc_warmnup = [
    {
        "cmd": "aws s3 cp s3://recommendation-data-bagpipe/kaggle_criteo_info ./ && aws s3 cp s3://recommendation-data-bagpipe/kaggle_artificial_1_use_90_fraction_8 ./kaggle_artificial_1_use_90_fraction_8 --recursive && aws s3 cp s3://recommendation-data-bagpipe/emb_table_info.txt ./ && aws s3 cp s3://recommendation-data-bagpipe/emb_table_info_h.txt ./"
    }
]
...
def run_large_scale():
    ...
    if with_dlrm:
        ...
        log_file_name = "run_dlrm_use_1_use_90_frac_{}_num_machines_{}_run_1".format(
