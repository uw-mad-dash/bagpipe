...
python OracleCacher/oracle_cacher.py -v --prefetch --lookahead-value 1 --mini-batch-size=$batch_size --dataset-multi-num 16 --worker-id $worker_id --world-size $world_size --cache --master-ip $master_ip --world-size-trainers $world_size_trainers --emb-info-file /home/ubuntu/emb_table_info.txt --processed-csv  /home/ubuntu/fgcnn_16 --stop-iter 3000 --cache-size 500000 2>&1 | tee out
