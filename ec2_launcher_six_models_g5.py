...
def run_large_scale():
    ...
    if with_dlrm:
        ...
        run_args_trainers = return_args_trainers_dlrm(
            private_ip_trainers, private_ip_oracle_cacher, log_file_name, iterations, cache_size
        )
    ...
    if with_fgcnn:
        ...
        # ========Launching Bagpipe run 1========================================
        log_file_name = "run_fgcnn_{}_num_machines_{}_run_g5".format(
            len(private_ip_trainers), batch_size
        )
    ...
    if with_caser:
        cache_size = 500000
        # ========Launching Bagpipe run 1========================================
        log_file_name = "run_caser_{}_num_machines_{}_run_g5".format(
            len(private_ip_trainers), batch_size
        )
